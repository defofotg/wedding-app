package com.enai.weddingapp.application.global.config;

import com.enai.weddingapp.application.global.exception.EmptyFileException;
import com.enai.weddingapp.domain.invitation.model.DomainException;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleEmptyFileException (
            RuntimeException ex, WebRequest request) {
        String bodyOfResponse = ex.getMessage();
        return handleExceptionInternal(ex, bodyOfResponse,
                new HttpHeaders(), HttpStatus.EXPECTATION_FAILED, request);
